...
export function getScopeColorClasses(color: string): ColorClasses {
  const mapping: Record<string, ColorClasses> = {
    ...
    sky: {
      ...
      glow: "shadow-[0_0_15px_rgba(14,165,233,0.35)]",
    },
    amber: {
      bg: "bg-amber-500",
    ...
    orange: {
      bg: "bg-spendscope-500",
      text: "text-spendscope-600 dark:text-spendscope-400",
      border: "border-spendscope-500/20",
      lightBg: "bg-spendscope-500/10",
      glow: "shadow-[0_0_20px_rgba(243,128,32,0.4)]",
    },
    rose: {
      bg: "bg-rose-500",
    ...
    indigo: {
      ...
      glow: "shadow-[0_0_15px_rgba(79,70,229,0.35)]",
    },
    cyan: {
      bg: "bg-cyan-500",
