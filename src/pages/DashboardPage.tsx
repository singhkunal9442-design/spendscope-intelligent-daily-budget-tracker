  ...
  return (
    <div className="min-h-screen w-full bg-background text-foreground relative">
                ...
                {scopes.length === 0 ? (
                  ...
                  >
                    ...
                    <p className="mt-2 text-muted-foreground">
                      You have no spending categories yet. Go to Settings to add your first one.
                    </p>
                  </motion.div>
                ) : (
                  <>
      ...
      <Button
        ...
        className="fixed bottom-6 right-6 h-14 w-14 min-h-[56px] sm:h-16 sm:w-16 rounded-full shadow-lg z-50 bg-primary hover:bg-primary/90 transition-transform hover:scale-105 active:scale-95 animate-pulse"
        size="icon"
      >
